...
const Footer: React.FC<FooterProps> = ({ onAdminClick, onPrivacyClick, onTermsClick, onCookieClick }) => {
  return (
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 border-t border-slate-900 pt-8 md:flex md:items-center md:justify-between">
          ...
          <div className="mt-4 md:mt-0 flex justify-center items-center space-x-6 text-sm text-slate-500">
            ...
            <button onClick={onCookieClick} className="hover:text-brand-500 transition-colors">Cookie</button>
            <button
