        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1 space-y-8">
            ...
            <div className={`flex flex-col sm:flex-row gap-4 pt-4 ${transitionClasses} delay-700 ${isVisible ? visibleState : hiddenState}`}>
              <a href="#servizi" className="inline-flex items-center justify-center px-8 py-4 border border-transparent text-base font-medium rounded-lg text-white bg-brand-600 hover:bg-brand-500 hover:scale-105 hover:shadow-xl hover:shadow-brand-500/40 transition-all duration-300 shadow-lg shadow-brand-600/20">
                Scopri i servizi
